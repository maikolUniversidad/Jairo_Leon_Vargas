...
export function ChatComposer({
  ...
  return (
    <div
      className={`border-t border-gray-200 bg-white p-3 sm:p-4 ${dragOver ? 'bg-primary/5' : ''}`}
    ...
    >
      ...
      <div className="mx-auto flex max-w-3xl items-end gap-2">
        ...
        <button
          ...
          className="h-11 w-11 shrink-0 flex items-center justify-center rounded-xl bg-gray-100 text-gray-500 transition-colors hover:bg-gray-200 disabled:opacity-50"
        >
        ...
        <button
          ...
          className={[
            'h-11 w-11 shrink-0 flex items-center justify-center rounded-xl transition-colors',
            recording
        ...
        <div className="flex-1 rounded-2xl border border-gray-200 bg-gray-50 px-3 py-2 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20">
          <textarea
            ref={taRef}
            value={value}
        ...
        {streaming ? (
          <button
            ...
            className="h-11 w-11 shrink-0 flex items-center justify-center rounded-xl bg-gray-800 text-white transition-colors hover:bg-gray-900"
          >
          ...
          <button
            ...
            aria-label="Enviar"
            className="h-11 w-11 shrink-0 flex items-center justify-center rounded-xl bg-primary text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-40"
          >
